        ...
        <div class="container py-5">
            <div class="row px-4 px-lg-5">
                <div class="col-lg-6">
                    ...
                    <h1 class="h2 text-uppercase mb-3">Trust is our motto</h1>
        ...
        @if(isset($product_categories[0]))
            <div class="col-md-4 mb-4 mb-md-0">
                <a class="category-item" href="{{ route('frontend.shop', $product_categories[0]->slug) }}">
                    ...
                    <strong class="category-item-title">Power Bank</strong>
                </a>
            </div>
            @endif
            @if(isset($product_categories[1]))
            <div class="col-md-4 mb-4 mb-md-0">
                <a class="category-item mb-4" href="{{ route('frontend.shop', $product_categories[1]->slug) }}">
                    ...
                    <strong class="category-item-title">VR</strong>
                </a>
                @endif
                @if(isset($product_categories[2]))
